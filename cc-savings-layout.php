...
<div class="CCWidget CC-Widget-<?php echo $id; ?>">
        ...
        <div class="ccrowdiv">
			 <div class="ccleftdiv">
                <label for="<?php echo $id; ?>-deposit">Deposit <?php echo esc_attr($currency); ?> :</label>
			 </div>
        ...
        <div class="ccrowdiv">
			 <div class="ccleftresultdiv">
                <label for="<?php echo $id; ?>-interest">Interest earned <?php echo esc_attr($currency); ?> :</label>
			 </div>
        ...
        <?php if ($show_url) { ?>
    		<div class="ccrowdiv" >
                <div id="CCWidgetSignature">Provided by <a href="https://CalculatorsCanada.ca" target="_blank">CalculatorsCanada.ca</a></div>
		    </div>
        <?php } ?>
